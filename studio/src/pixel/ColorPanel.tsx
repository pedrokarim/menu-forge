...
/** Palette par défaut : tons de l’interface de Minecraft, du thème Deepslate et les 16 couleurs du chat. */
const DEFAULT_PALETTE: ReadonlyArray<{ hex: string; name: string }> = [
