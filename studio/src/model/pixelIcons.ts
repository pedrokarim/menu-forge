...
const MATRICES: Record<PixelIcon, readonly string[]> = {
  ...
  digit_8: ['.####.', '##..##', '##..##', '.####.', '##..##', '##..##', '##..##', '.####.'],
  digit_9: ['.####.', '##..##', '##..##', '##..##', '.#####', '....##', '...##.', '.###..'],
  // Économie : pièce, tendances, recherche, temps, quantités, tri, filtre, graphe, enchère, retrait.
  coin: ['..####..', '.##..##.', '##....##', '##.##.##', '##.##.##', '##....##', '.##..##.', '..####..'],
  trend_up: ['...##...', '..####..', '.######.', '########', '...##...', '...##...', '...##...', '...##...'],
  trend_down: ['...##...', '...##...', '...##...', '...##...', '########', '.######.', '..####..', '...##...'],
  trend_flat: ['....#...', '....##..', '....###.', '########', '########', '....###.', '....##..', '....#...'],
...
export const PIXEL_ICON_LABELS: Record<PixelIcon, string> = {
  ...
  digit_8: 'Chiffre 8',
  digit_9: 'Chiffre 9',
  coin: 'Pièce (prix, acheter)',
  trend_up: 'Flèche de hausse',
  trend_down: 'Flèche de baisse',
  trend_flat: 'Flèche stable',
  search: 'Loupe (recherche)',
  clock: 'Horloge (durée)',
  plus: 'Plus',
  minus: 'Moins',
  check: 'Coche (valider)',
  sort: 'Barres (trier)',
  filter: 'Entonnoir (filtrer)',
  chart: 'Histogramme (cours)',
  auction: 'Maillet (enchère)',
  withdraw: 'Boîte (retrait)',
};
